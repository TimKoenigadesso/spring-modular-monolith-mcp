// AGSDLC-10: MCP-Layer — Orchestrierungsschicht über öffentliche Modul-APIs
// Katalog: ProductApi | Bestellungen: OrdersApi | Inventar: InventoryApi
    ...
    public List<Map<String, Object>> listTools() {
        return List.of(
                ...
                tool(
                        ...
                        Map.of(
                                "page",
                                Map.of("type", "integer", "description", "Seitennummer (ab 1)"),
                                "status",
                                Map.of(
                                        "type",
                                        "string",
    ...
    public Object callTool(String name, Map<String, Object> args) {
        return switch (name) {
            ...
            case "update_order_status" -> {
                ...
                ordersApi.updateOrderStatus(num, ns);
            ...
            case "get_stock_level" -> {
                ...
                Long qty = inventoryApi.getStockLevel(code);
                yield Map.of("productCode", code, "quantity", qty != null ? qty : 0L);
            }
